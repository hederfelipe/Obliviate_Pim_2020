		...
		return (<Container>
                ...
                <Header titulo="Cadastro"></Header>   
                    ...
                    <Col md="12">
                        ...
                        <input className="form-control font-valores"  placeholder="Digite seu Email" type="email" id="email" value={this.state.email} onChange={this.setEmail.bind(this)}/>
                    </Col>                
            ...
            return (<Container>
                ...
                <Header titulo="Login"></Header>          
                    <Col md="12">
                        ...
                        <input className="form-control font-valores" type="email" placeholder="Email" id="login-email" value={this.state.email} onChange={this.setEmail.bind(this)}/>
                    </Col>
